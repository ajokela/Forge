...
trait RewriteOpsExp extends RewriteOps with DenseVectorViewOpsExp {
  ...
  // This rewrite is added to remove temporary allocations on vector dot product when one of them is mutable. (ex: Hogwild)
  ...
  /*
  override def densevector_mulclnmul[T:Manifest](self: Rep[DenseVector[T]],__arg0: Rep[DenseVector[T]])(implicit __pos: SourceContext,__imp0: Arith[T],__imp2: Overload5) = {
    reflectPure(VectorDotProduct(self,__arg0))
  }
  */

  override def densevector_mulclnmul[T:Manifest](self: Rep[DenseVector[T]],__arg0: Rep[DenseVectorView[T]])(implicit __pos: SourceContext,__imp0: Arith[T],__imp2: Overload6) = {
    reflectPure(VectorDotProduct(self,__arg0))
  }
